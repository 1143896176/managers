					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-coffee"></i>所有公告</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-480">公告日期</th>

											<th class="hidden-480">公告标题</th>
								...
								<c:forEach items="${announce_list }" var="announce">
										<tr class="odd gradeX">

											<td><input type="checkbox" class="checkboxes" value="${ announce.announce_id}" /></td>

											<td>${ announce.announce_id}</td>
											
										<td class="hidden-480"><fmt:formatDate value="${announce.announce_date }" pattern="yyyy/MM/dd HH:mm:ss"/></td>
								
											<td class="hidden-480">${ announce.announce_title}</td>
											
											<td class="hidden-480">${ announce.announce_content}</td>
