...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-coffee"></i>未读留言</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<a href="javascript:void(0)" onclick="update(this);">${list.message_name }</a>
								...
								<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="addDivLabel">  
    <div class="modal-dialog" role="document">  
        <div class="modal-content">  
            ...
            <div class="modal-body">  
     		<form action="readmessage.do" method="post" class="form-group">
