					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>添加台球桌</div>
							...
							<div class="portlet-body form">
								...
								<form action="adminbill.do" id="form_sample_1" class="form-horizontal">



									<div class="control-group">

										<label class="control-label">出厂地信息<span class="form-horizontal">*</span></label>

										<div class="controls">

											<input type="text"  data-required="1" class="span6 m-wrap"  name="origin" />
									...
									<div class="control-group">
										...
										<label class="control-label">价格<span class="form-horizontal">*</span></label>

										<div class="controls">

											<input name="price" placeholder="(元/小时)" type="text" class="span6 m-wrap"/>
									...
									<div class="control-group">
										...
										<label class="control-label">位置信息<span class="form-horizontal">*</span></label>

										<div class="controls">

											<input name="location" type="text" class="span6 m-wrap"/>
