					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>添加公告</div>
							...
							<div class="portlet-body form">
								...
								<form action="adminannoun.do" id="form_sample_1" class="form-horizontal">

									<div class="control-group">

										<label class="control-label">公告标题<span class="form-horizontal">*</span></label>

										<div class="controls">
											<input type="hidden" name="billard_id" value="${ admin.billard_id}"/>
											<input type="text"  data-required="1" class="span6 m-wrap" id="tel" name="announ_title" onkeyup="check()" onblur="check()"/>
									...
									<div class="control-group">
										...
										<label class="control-label">公告内容<span class="form-horizontal">*</span></label>

										<div class="controls">

											<textarea name="announ_content" rows="10" class="span6 m-wrap"/></textarea>
