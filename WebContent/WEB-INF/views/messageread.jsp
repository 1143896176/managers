...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box red">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-coffee"></i>已阅留言</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<c:forEach var="list" items="${ messageread_list }">
										
										<tr class="odd gradeX">

											<td> ${list.message_id }</a></td>
											

											<td>
											
											<a href="javascript:void(0)" onclick="view(this);">${list.message_name }</a>
											
											</td>
											

											<td class="hidden-480"><fmt:formatDate value="${list.message_date }" pattern="yyyy-MM-dd HH:mm:ss"/></td>

											<td class="hidden-480">${list.member_id }</td>

											<td  style="display:none;">${list.message_content }</td>
									...
									<div class="modal fade" id="view" tabindex="-1" role="dialog" aria-labelledby="addDivLabel">  
    <div class="modal-dialog" role="document">  
        <div class="modal-content">  
            <div class="modal-header">  
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span  
                        aria-hidden="true"></span></button>  
                <h4 class="modal-title" id="addDivLabel">查看留言</h4>  
            </div>  
            <div class="modal-body">  
     		
  				<div>
  				<input id="data_id" type="hidden" name="message_id" />
					留言内容		<textarea style="width:100%;height:150px;" id="content">  			</textarea>	
  				</div>
	...
	<script>
	 ...
	 function view(obj) {  
        ...
        $('#data_id').val(tds.eq(0).text()); 
        $('#content').val(tds.eq(4).text());        
        $('#view').modal('show');  
    } 
