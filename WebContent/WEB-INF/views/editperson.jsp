									...
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											...
											<div class="form-horizontal form-view">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" name="admin_login_name" value="${admin.username }" disabled="disabled"/>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" name="admin_tel" value="${admin.admin_tel }" />
												...
												<h3 class="form-section">台球厅信息</h3>
												...
												<div class="row-fluid">
													...
													<div class="span12 ">
														...
														<div class="control-group">
															...
															<label class="control-label" >台球厅id:</label>

															<div class="controls">

																<input type="text" name="billard_id" value="${admin.billard_id }" disabled="disabled"/>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" name="billard_name" value="${admin.billard_name }" />
													...
													<div class="span6">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" name="billard_address" value="${admin.billard_address }" />
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																	...
																	<textarea style="width:100%;height:150px;" id="content">  	</textarea>	
												...
												<div class="form-actions">
													...
													<button type="submit" class="btn blue"><i class="icon-pencil"></i> 修改</button>
